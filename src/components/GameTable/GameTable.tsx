...
import { GameClass, Player, Owner, IWinner } from "@shared"
import { ICoordinates, IGameDataNumeric, ITableField } from "@types"
...
export function GameTable({ gameField, onUserClick }: Props) {
